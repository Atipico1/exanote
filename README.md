...
Apple M4, 메모리 32GB인 Mac에서 한국어 토론 음성으로 측정했습니다.

- **48분 23초 전사:** 약 5분짜리 파일 10개를 처리하는 데 8분 1초가 걸렸습니다. 공백과 문장부호를 뺀 글자 오류율은 7.68%였습니다. 이 시간에는 화자 구분과 회의 노트 작성이 포함되지 않습니다.
