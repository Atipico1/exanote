...
<p align="center">
  <strong>회의를 녹음하거나 파일을 가져오세요.</strong><br>
  누가 말했는지 나눠 적고, 영어 회의는 녹음 중 한국어로 보여줍니다.
</p>
...
Apple M4 · 메모리 32GB Mac에서 한국어 토론 녹음 10개(총 48분 23초)를 전사했습니다. 이 10개는 Exanote의 전사 방식을 조정할 때도 사용한 개발용 녹음입니다.

| 개발용 녹음 10개의 글자 오류율 | Exanote | T사 |
| --- | ---: | ---: |
| 공백·문장부호 제외 | 7.68% | 6.51% |

오류율은 **낮을수록 정확합니다.** 같은 10개 녹음을 두 방식으로 전사했지만, Exanote는 이 녹음으로 방식을 조정했으므로 이 표만으로 일반적인 성능을 비교할 수는 없습니다. 별도 녹음 8개에서 Exanote의 오류율은 9.24%였고, T사는 측정하지 않았습니다.
